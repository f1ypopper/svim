...
class Lexer {
    ...
    scanToken() {
        let c = this.advance();
        switch (c) {
            case '+': { return this.addToken(tokenType.Plus); break; }
            case '-': { return this.addToken(tokenType.Minus); break; }
            case '/': { return this.addToken(tokenType.Slash); break; }
            case '*': { return this.addToken(tokenType.Star); break; }
            case '(': { return this.addToken(tokenType.LeftParen); break; }
            case ')': { return this.addToken(tokenType.RightParen); break; }
            case ',': { return this.addToken(tokenType.Comma); break; }
            case ' ': { return; break; }
            default: {
                if (isLetter(c)) {
